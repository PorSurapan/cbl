    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <form id="quiz" name="quiz">
                ...
                <h5><br>1) จงเขียนคำสั่งที่ถูกต้องเพื่อเชื่อมต่อไปยัง Host "localhost"<br></h5>
                <h5><br>2) จงเขียนคำสั่งที่ถูกต้องเพื่อทำการเชื่อมต่อฐานข้อมูลที่ชื่อว่า studyphp<br></h5>
                <h5><br>3) จงเขียนคำสั่งที่ถูกต้องเพื่อเลือกชุดอักขระภาษาไทย เป็น UTF8<br></h5>
                <h5><br>4) จงเขียนคำสั่งที่ถูกต้องเพื่อปิดการเชื่อมต่อฐานข้อมูล<br><br></h5>
                <h6>&#60;?php<br><br></h6>
