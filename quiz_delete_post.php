...
<head>
    <title>Post-Test การลบข้อมูล - Database Management with PHP</title>
    <meta charset="utf-8">
    ...
    <script src="save_quiz_delete_post.js"></script>
...
<body>
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            <h2 class="mb-4" id="top">แบบทดสอบหลังเรียน - การลบข้อมูล</h2>
