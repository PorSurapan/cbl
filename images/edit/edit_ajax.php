...
<head>
    ...
    <script src="ajax_edit.js"></script>
</head>
<body>
    <form method="POST">    
    <div class="container">
        ...
        <input type="button" id="submit" value="บันทึก" onclick="editAJAX(uid.value, firstName.value, lastName.value, address.value, birthDay.value);">
