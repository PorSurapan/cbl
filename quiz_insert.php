    ...
    <div class="wrapper d-flex align-items-stretch">
        ...
        <div id="content" class="p-4 p-md-5 pt-5">
            ...
            <form id="quiz" name="quiz">
                ...
                <h5><br>2) จงเขียนคำสั่งในฟังก์ชันให้ทำงานได้อย่างสมบูรณ์<br><br></h5>
                <h6>function registerUser(usn, fn, pwd, cpd)<br><br>{</h6>
                <h6  style="text-indent: 2.5em;">if(pwd != cpd) {</h6>
                <h6  style="text-indent: 2.5em;">var x = document. <input type="text" id="textBox21" name="question21" >("snackbar");</h6>
                <p id="checkQ21"></p>
                <h6  style="text-indent: 2.5em;">x.className = "show";</h6>
                <h6  style="text-indent: 2.5em;">setTimeout(function(){ x.className = x.className.replace("show", ""); }, 3000);</h6>
                <h6><br>} else {</h6>
                <h6 style="text-indent: 2.5em;"><input type="text" id="textBox22" name="question22" >();</h6>
                <p id="checkQ22"></p>
                <h6 style="text-indent: 2.5em;">xmlHttp.<input type="text" id="textBox23" name="question23" > = stateChange;<br></h6>
                <p id="checkQ23"></p>
                <h6  style="text-indent: 2.5em;">var url = "userRegister.php";</h6>
                <h6  style="text-indent: 2.5em;">url = url + "?username=" + usn + "&full_name=" + fn + "&password=" + pwd;</h6>
                <h6  style="text-indent: 2.5em;">xmlHttp.<input type="text" id="textBox24" name="question24" >("GET", url, true);</h6>
                <p id="checkQ24"></p>
